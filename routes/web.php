...
Route::middleware(['auth:sanctum', 'verified'])->get('/certificates', Certificates::class)->name('certificates');

/*Route::get('/certificate/{company_name}/{certificate_code}', View::class)->name('viewCertificate');*/
