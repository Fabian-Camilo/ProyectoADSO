        ...
        <div
            ...
            <div class="w-full flex items-center justify-center">
                <div class="flex flex-col items-center">
                    <img tabindex="0" class="focus:outline-none my-4" style="max-width: 150px"
                        src="{{ asset('storage/' . $company->logo_photo_path) }}" alt="{{ $company->name }}">
                    <p tabindex="0"
            ...
            <table class="mx-1 divide-y divide-gray-200 text-sm table-fixed table-auto">
                <tbody>
                    <tr class="py-10">
                    ...
                    @if (count($elements))
                        @foreach ($elements as $key => $item)
                            <tr class="py-10">
                                <td class="px-10 py-3 font-medium text-left">
                                    <div class="text-sm font-medium font-bold text-gray-900">
                                        {{ $item['name'] }}
                                    </div>
                                </td>
                                <td class="px-10 py-3 font-medium text-right">
                                    <div class="text-sm font-medium text-gray-900">
                                        {{ $item['value'] }}
                                    </div>
                                </td>
            ...
            <div class="w-full flex justify-center mt-7">
                <div class="flex flex-col">
                    <a href="{{url('mailto:'.$company->email)}}">
                    <button
