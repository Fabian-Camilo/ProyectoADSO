    ...
    <div class="mt-8 text-2xl">
        ...
        <div class="bg-white rounded-3xl border shadow-xl p-8 w-100">
            <div class="flex justify-between items-center mb-4">
                <button class="inline-flex items-center justify-center w-14 h-14 rounded-lg">
                    <img style="max-width: 100px; margin: 10px;  "
...
{{-- <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laravel.com/docs">Plans</a>
            </div>
        </div>
